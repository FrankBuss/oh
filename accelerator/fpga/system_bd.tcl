...
CONFIG.MAX_BURST_LENGTH {256} \
 ] [get_bd_intf_pins /axi_accelerator_0/m_axi]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {2} \
CONFIG.NUM_WRITE_OUTSTANDING {2} \
 ] [get_bd_intf_pins /axi_accelerator_0/s_axi]
...
CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#tx#rx#data[0]#cmd#clk#data[1]#data[2]#data[3]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#mdc#mdio} \
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_net -net Net [get_bd_ports gpio_p] [get_bd_pins axi_accelerator_0/gpio_p]
  connect_bd_net -net Net1 [get_bd_ports gpio_n] [get_bd_pins axi_accelerator_0/gpio_n]
